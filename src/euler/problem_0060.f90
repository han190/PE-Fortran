submodule(interface_module) euler_problem_0060_submodule
  implicit none
...
contains
  ...
  subroutine is_prime_pair(pair, is_prime_, flag, succeed)
  ...
  subroutine checked_before(idx, concs, flags, ret)
  ...
  subroutine next_combination(k, n, flags, idx, ret)
...
end submodule euler_problem_0060_submodule
