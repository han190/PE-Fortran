submodule(interface_module) euler_problem_0012_submodule
  implicit none
...
contains
  ...
  pure integer(i32) function answer()
    use prime_module, only: Sieve_of_Eratosthenes, number_of_divisors
    implicit none
...
end submodule euler_problem_0012_submodule
