module euler_utils_m
    ...
    public :: findloc
    interface findloc
        module procedure findloc_1d_int32
        module procedure findloc_1d_char
        module procedure findloc_1d_logical
...
contains
    ...
    function next_permutation_int32(k, n, idx) result(ret)
        ...
        if (all(carr .eqv. .true.)) then
            ...
            x = findloc_1d_logical(carr, val=.false., dim=1) - 1
    ...
    function findloc_1d_int32(arr, val, dim, back) result(ret)
        integer, intent(in) :: arr(:), val
        integer, intent(in), optional :: dim
        logical, intent(in), optional :: back
        integer :: ret, dim_opt, i, i_start, i_end, i_step
        logical :: back_opt
    ...
    end function findloc_1d_int32

    function findloc_1d_char(arr, val, dim, back) result(ret)
        character(len=*), intent(in) :: arr(:), val
        integer, intent(in), optional :: dim
        logical, intent(in), optional :: back
        integer :: ret, dim_opt, i, i_start, i_end, i_step
        logical :: back_opt
    ...
    end function findloc_1d_char

    function findloc_1d_logical(arr, val, dim, back) result(ret)
    ...
    end function findloc_1d_logical
